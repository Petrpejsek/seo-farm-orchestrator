...
SCHEMA_PATH = Path('/Users/petrliesner/Farm new new new/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin': '/Users/petrliesner/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    assistant: 'actions.AssistantActions[models.Assistant]'
    workflowrun: 'actions.WorkflowRunActions[models.WorkflowRun]'
    ...
    def __init__(
        ...
        *,
        ...
        self.assistant = actions.AssistantActions[models.Assistant](self, models.Assistant)
        self.workflowrun = actions.WorkflowRunActions[models.WorkflowRun](self, models.WorkflowRun)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/petrliesner/Farm new new new/prisma/schema.prisma',
        }
...
class Batch:
    ...
    assistant: 'AssistantBatchActions'
    workflowrun: 'WorkflowRunBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.assistant = AssistantBatchActions(self)
        self.workflowrun = WorkflowRunBatchActions(self)
